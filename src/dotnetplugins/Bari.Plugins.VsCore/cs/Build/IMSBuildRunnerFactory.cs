...
namespace Bari.Plugins.VsCore.Build
{
    ...
    {
        MSBuildRunner CreateMSBuildRunner(SlnBuilder slnBuilder, TargetRelativePath slnPath, MSBuildVersion version, bool restore, bool includeOutputSubdirectories);
    }
}
